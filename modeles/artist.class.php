...
class Artist extends Entity{
    ...
    */
	...
	// récupère les artistes recherché
	public static function getRecherch($nom)
    {
        $sql="SELECT * FROM artist where nom like '%". $nom."%'";
        $resultat=MonPdo::getInstance()->query($sql);
        $ArtistRech=$resultat->fetchAll(PDO::FETCH_CLASS|PDO::FETCH_PROPS_LATE,'Artist');
        return $ArtistRech;
    }
}