			...
			<li class="first">
				<span class="opener">Les artistes<b></b></span>
					<ul>
						...
						<li><a href="index.php?uc=Artistes&action=rechercher">Rechercher un artiste</a></li>
					</ul>
			</li>
			<li class="first">
				<span class="opener">Les genres<b></b></span>
					<ul>
						<li><a href="index.php?uc=Genre&action=all">Liste des genres</a></li>
					</ul>
			</li>
			<li class="first">
				<span class="opener">Les albums<b></b></span>
					<ul>
						...
						<li><a href="index.php?uc=Albums&action=recherchalbum">Rechercher un album</a></li>
					</ul>
			</li>
		</ul>
		<br class="clearfix" />
